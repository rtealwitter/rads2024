...
Today, we will analyze a powerful algorithm using only simple probability tools.
...
We'll prove the inequality directly.
...
With a few more applications of Markov's inequality, we can show that

**Claim**: If we make $m = \Omega(\frac{\sqrt{n}}{\epsilon})$ samples, then
